...
import { IsString, IsOptional, IsEnum, IsBoolean, IsNumber, IsArray, IsIn, IsMongoId } from 'class-validator';
import { VALID_FUEL_TYPES, VALID_TRANSMISSION_TYPES, VALID_VEHICLE_TYPES } from '../../common/constants/vehicle.constants';

export class UpdateModelDto {
  @IsOptional()
  @IsString()
  @ApiPropertyOptional({ example: 'Toyota Camry', description: 'Name of the vehicle model' })
  name?: string;
  ...
  @IsOptional()
  @IsBoolean()
  @ApiPropertyOptional({ example: false, description: 'Whether this is a commercial vehicle (boolean: true/false)' })
  ...
  @IsOptional()
  @IsBoolean()
  @ApiPropertyOptional({ example: true, description: 'Whether the model is active (boolean: true/false)' })
  isActive?: boolean;

  @IsOptional()
  @IsMongoId()
  @ApiPropertyOptional({ example: '507f1f77bcf86cd799439011', description: 'Manufacturer ID (MongoDB ObjectId)' })
