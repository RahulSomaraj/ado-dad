...
import { IsString, IsNotEmpty, IsEnum, IsOptional, IsBoolean, IsNumber, IsArray, IsMongoId, IsObject, IsDateString } from 'class-validator';
...
export class CreateVehicleVariantDto {
  ...
  @IsNotEmpty()
  @IsMongoId()
  @ApiProperty({ example: '507f1f77bcf86cd799439011', description: 'Model ID (MongoDB ObjectId)' })
  modelId: string;
  ...
  @IsOptional()
  @IsBoolean()
  @ApiPropertyOptional({ example: true, description: 'Whether the variant is active (boolean: true/false)', default: true })
  isActive?: boolean;

  @IsOptional()
  @IsBoolean()
  @ApiPropertyOptional({ example: false, description: 'Whether the variant is launched (boolean: true/false)', default: false })
  isLaunched?: boolean;
