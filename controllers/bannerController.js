...
exports.createBanner = async (req, res) => {
	try {
		...
		return res
			.status(500)
			.json({ message: "Failed to create banner", error: err.message });
	}
};
...
exports.getBannerById = async (req, res) => {
	try {
		...
		return res
			.status(500)
			.json({ message: "Failed to fetch banner", error: err.message });
	}
};
...
exports.updateBanner = async (req, res) => {
	try {
		...
		return res
			.status(500)
			.json({ message: "Failed to update banner", error: err.message });
	}
};
